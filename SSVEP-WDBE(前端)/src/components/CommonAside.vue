        ...
        <el-container>
            ...
            <el-scrollbar height="630px">
                <el-main>
                    ...
                    <div class="con" @click="clickMenu('/main/HomeView')">
                    ...
                    <el-sub-menu index="3">
                        ...
                        <el-menu-item-group>
                            <el-menu-item index="3-1"
                                @click="clickMenu('/main/VisualDetection/ColorPerception')">颜色感知</el-menu-item>
                    ...
                    <el-sub-menu index="4">
                        ...
                        <el-menu-item-group>
                            <el-menu-item index="4-1" @click="clickMenu('/main/EyeHealth/GlaucomaTest')">青光眼检测</el-menu-item>
                            <el-menu-item index="4-2"
                                @click="clickMenu('/main/EyeHealth/CataractDetection')">白内障检测</el-menu-item>
                            <el-menu-item index="4-3" @click="clickMenu('/main/EyeHealth/MacularTest')">黄斑病检测</el-menu-item>
                        </el-menu-item-group>
                    </el-sub-menu>
